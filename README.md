<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0f172a&height=300&section=header&text=TruthLens&fontSize=90&fontColor=38bdf8&animation=twinkling&fontAlign=50&fontAlignY=35&desc=Next-Generation%20Forensic%20Intelligence%20System&descAlign=50&descAlignY=55&descSize=24" alt="TruthLens Banner" width="100%" />
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/Engine_Status-Active-38bdf8?style=for-the-badge&logo=activity&logoColor=white" alt="Status" />
  <img src="https://img.shields.io/badge/Precision-99.9%25-f43f5e?style=for-the-badge&logo=target&logoColor=white" alt="Precision" />
  <img src="https://img.shields.io/badge/AI_Core-v4.0_Quantum-8b5cf6?style=for-the-badge&logo=openai&logoColor=white" alt="AI Core" />
...
<table align="center" width="100%">
  <tr>
    <td width="33%" align="center">
      ...
      <img src="https://skillicons.dev/icons?i=md" width="60" alt="Docs"/>
      <br/><br/>
    ...
    <td width="33%" align="center">
      ...
      <img src="https://skillicons.dev/icons?i=audio" width="60" alt="Audio"/>
       <br/><br/>
    ...
    <td width="33%" align="center">
      ...
      <img src="https://skillicons.dev/icons?i=discord" width="60" alt="Video"/>
       <br/><br/>
...
```mermaid
graph TD;
    A[Client UI - React/Vite/Tailwind] -->|WSS / REST| B(Edge Hub / Node Router);
    B --> C{Core Forensic Engine};
    C -->|Text Pipeline| D[NLP Deep Analysis Module];
    C -->|Audio Pipeline| E[Acoustic Signature Analyzer];
    C -->|Video Pipeline| F[Computer Vision Frame Extraction];
    D --> G[(Supabase / PostgreSQL)];
    E --> G;
    F --> G;
    G --> H[Forensic Dashboard & PDF Report Generation];
    
    style A fill:#0f172a,stroke:#38bdf8,stroke-width:2px,color:#fff
    style B fill:#0f172a,stroke:#8b5cf6,stroke-width:2px,color:#fff
    style C fill:#1e1e2f,stroke:#f43f5e,stroke-width:2px,color:#fff
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=0f172a&height=100&section=footer&text=Secure.%20Analyze.%20Verify.&fontSize=28&fontColor=38bdf8&fontAlignY=50" width="100%"/>
</p>
<p align="center">
